...
| L3 | Conjunto de validação anotado ainda não existe | Construir (≥ 30 máscaras + 10 peças com paquímetro) | S1–S2 |
...
| L5 | Licença do SAM 3 ("SAM License") não auditada para uso comercial | Auditar antes de adotá-lo em produção; BiRefNet (MIT) é alternativa sem risco | S2 (bake-off) |
